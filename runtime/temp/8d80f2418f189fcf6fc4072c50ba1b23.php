<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:71:"D:\wamp\www\fastadmin\public/../application/admin\view\index\login.html";i:1557482263;s:61:"D:\wamp\www\fastadmin\application\admin\view\common\meta.html";i:1557482263;s:63:"D:\wamp\www\fastadmin\application\admin\view\common\script.html";i:1557482263;}*/ ?>
<!DOCTYPE html>
<html lang="en">
    <head>
        <meta charset="utf-8">
                ...
                <div class="login-screen">
                    <div class="well">
                        <div class="login-form">
                            <img id="profile-img" class="profile-img-card" src="/fastadmin/public/assets/img/avatar.png" />
                            ...
                            <form action="" method="post" id="login-form">
                                ...
                                <div class="input-group">
                                    ...
                                    <span class="input-group-addon" style="padding:0;border:none;cursor:pointer;">
                                        <img src="<?php echo rtrim('/fastadmin/public/', '/'); ?>/index.php?s=/captcha" width="100" height="30" onclick="this.src = '<?php echo rtrim('/fastadmin/public/', '/'); ?>/index.php?s=/captcha&r=' + Math.random();"/>
                                    </span>
                                </div>
                                <?php endif; ?>
